...
def battle_potentiometer():
    ...
    enemy_sprite = pygame.image.load("assets/sprites/enemy_sprite_frog.png").convert_alpha()
    ...
    # Reward Sprite
    reward = pygame.image.load('assets/sprites/Potentiometer.png')
    ...
    dialogues = ["A wild monster appeared!", "The monster has seized the potentiometer! ", "Beware, for it now wields the power of adjustable resistance against you."]
    current_dialogue = 0
    ...
    questions = [
        {
            "question": "What is the main function of a potentiometer?",
            "choices": ["Control", "Light", "Create"],
            "correct_answer": "Control"
        },
        {
            "question": "Is a potentiometer's resistance value fixed?",
            "choices": ['Yes', 'No', 'Maybe'],
            "correct_answer": "No"
        },
        {
            "question": "What aspect of a circuit does a potentiometer primarily control?",
            "choices": ["Resistance", "Volts", "Ampere"],
            "correct_answer": "Resistance"
        },
        {
            "question": "How many terminals does a standard potentiometer have?",
            "choices": ["One", "Two", "Three"],
            "correct_answer": "Three"
        },
        {
            "question": "What are the types of DC potentiometer?",
            "choices": ["Linear Potentiometer", "Square Potentiometer", "Triangle Potentiometer"],
            "correct_answer": "Linear Potentiometer"
        }
    ]
    ...
    class Enemy(pygame.sprite.Sprite):
        def __init__(self, pos_x, pos_y):
            ...
            self.sprites = []
            sprite_paths = ['assets/sprites/frog_1.png', 'assets/sprites/frog_2.png', 'assets/sprites/frog_3.png', 'assets/sprites/frog_4.png']
        ...
        if current_dialogue < len(dialogues) and not game_ended and not game_lost:
            ...
            if current_dialogue < len(dialogues):
                ...
                if not game_lost:
                    ...
                    window.blit(dialogue_image, (-100, WINDOW_HEIGHT - box_height - 55))
                    display_text(f"Behold your triumph: a Potentiomter, now yours!", WINDOW_WIDTH // 2, WINDOW_HEIGHT // 1.15,
                                 'green')
