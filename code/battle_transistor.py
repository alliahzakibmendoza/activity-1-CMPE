...
def battle_transistor():
    ...
    enemy_sprite = pygame.image.load("assets/sprites/enemy_sprite_racoon.png").convert_alpha()
    ...
    # Reward Sprite
    reward = pygame.image.load('assets/sprites/Transistor.png')
    ...
    dialogues = ["A wild monster appeared!", "The monster has seized the Transistor! ", "Beware, for it now wields the power of conversion against you."]
    current_dialogue = 0
    ...
    questions = [
        {
            "question": "What controls the current flow between collector and emitter in a transistor?",
            "choices": ["Base", "Bottom", "Left"],
            "correct_answer": "Base"
        },
        {
            "question": "What is the name for the opposite of a PNP transistor?",
            "choices": ['PPN', 'NPN', 'NNN'],
            "correct_answer": "NPN"
        },
        {
            "question": "What material are most common transistors made of?",
            "choices": ["Latex", "Rubber", "Silicon"],
            "correct_answer": "Silicon"
        },
        {
            "question": "What amplifies a signal in a transistor?",
            "choices": ["Catcher", "Collector", "Base"],
            "correct_answer": "Collector"
        },
        {
            "question": "____ conductor is the basic building block of a transistor?",
            "choices": ["Semi", "Full", "Half"],
            "correct_answer": "Semi"
        }
    ]
    ...
    class Enemy(pygame.sprite.Sprite):
        def __init__(self, pos_x, pos_y):
            ...
            self.sprites = []
            sprite_paths = ['assets/sprites/racoon_1.png', 'assets/sprites/racoon_2.png', 'assets/sprites/racoon_3.png', 'assets/sprites/racoon_4.png']
        ...
        if current_dialogue < len(dialogues) and not game_ended and not game_lost:
            ...
            if current_dialogue < len(dialogues):
                ...
                if not game_lost:
                    ...
                    window.blit(dialogue_image, (-100, WINDOW_HEIGHT - box_height - 55))
                    display_text(f"Behold your triumph: a Transistor, now yours!", WINDOW_WIDTH // 2, WINDOW_HEIGHT // 1.15,
                                 'green')
