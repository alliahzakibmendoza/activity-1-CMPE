...
def battle_transformer():
    ...
    enemy_sprite = pygame.image.load("assets/sprites/enemy_sprite_cyclops1.png").convert_alpha()
    ...
    # Reward Sprite
    reward = pygame.image.load('assets/sprites/transformer.png')
    ...
    dialogues = ["A wild monster appeared!", "The monster has seized the transformer! ", "Beware, for it now wields the power of current against you."]
    current_dialogue = 0
    ...
    questions = [
        {
            "question": "Does a transformer increase energy?",
            "choices": ["Yes", "No", "Maybe"],
            "correct_answer": "No"
        },
        {
            "question": "Can DC be applied to transformers?",
            "choices": ['Yes', 'No', 'yuuh'],
            "correct_answer": "No"
        },
        {
            "question": "Can a transformer produce power?",
            "choices": ["Yes", "No", "Who knows"],
            "correct_answer": "No"
        },
        {
            "question": "Are transformers AC or DC?",
            "choices": ["AC", "DC", "Both"],
            "correct_answer": "AC"
        },
        {
            "question": "Do transformers create energy?",
            "choices": ["Yes", "No", "Nothing"],
            "correct_answer": "Yes"
        }
    ]
    ...
    class Enemy(pygame.sprite.Sprite):
        def __init__(self, pos_x, pos_y):
            ...
            self.sprites = []
            sprite_paths = ['assets/sprites/cyclops1_1.png', 'assets/sprites/cyclops1_2.png', 'assets/sprites/cyclops1_3.png', 'assets/sprites/cyclops1_4.png']
        ...
        if current_dialogue < len(dialogues) and not game_ended and not game_lost:
            ...
            if current_dialogue < len(dialogues):
                ...
                if not game_lost:
                    ...
                    window.blit(dialogue_image, (-100, WINDOW_HEIGHT - box_height - 55))
                    display_text(f"Behold your triumph: a tranformer, now yours!", WINDOW_WIDTH // 2, WINDOW_HEIGHT // 1.15,
                                 'green')
