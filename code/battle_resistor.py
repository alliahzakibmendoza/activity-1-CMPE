...
def battle_resistor():
    ...
    enemy_sprite = pygame.image.load("assets/sprites/enemy_sprite_resistor.png").convert_alpha()
    ...
    # Reward Sprite
    reward = pygame.image.load('assets/sprites/resistor.png')
    ...
    dialogues = ["A wild monster appeared!", "The monster has seized the Resistor! ", "Beware, for it now wields the power of resistance against you."]
    current_dialogue = 0
    ...
    questions = [
        {
            "question": "What is the component that reduces current?",
            "choices": ["Resistor", "Capacitor", "Inductor"],
            "correct_answer": "Resistor"
        },
        {
            "question": "What is the basic unit of measurement for resistor resistance?",
            "choices": ['Ampere', 'Ohm', 'Volt'],
            "correct_answer": "Ohm"
        },
        {
            "question": "What type of component is a resistor, active or passive?",
            "choices": ["Active", "Dynamic", "Passive"],
            "correct_answer": "Passive"
        },
        {
            "question": "What effect does a resistor have on the flow of electric current?",
            "choices": ["Enhances", "Blocks", "Divides"],
    ...
    class Enemy(pygame.sprite.Sprite):
        def __init__(self, pos_x, pos_y):
            ...
            self.sprites = []
            sprite_paths = ['assets/sprites/cyclops_1.png', 'assets/sprites/cyclops_2.png', 'assets/sprites/cyclops_3.png', 'assets/sprites/cyclops_4.png']
        ...
        if current_dialogue < len(dialogues) and not game_ended and not game_lost:
            ...
            if current_dialogue < len(dialogues):
                ...
                if not game_lost:
                    ...
                    window.blit(dialogue_image, (-100, WINDOW_HEIGHT - box_height - 55))
                    display_text(f"Behold your triumph: a Resistor, now yours!", WINDOW_WIDTH // 2, WINDOW_HEIGHT // 1.15,
                                 'green')
