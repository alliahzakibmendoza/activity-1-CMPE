...
def battle_capacitor():
    ...
    enemy_sprite = pygame.image.load("assets/sprites/enemy_sprite_frog1.png").convert_alpha()
    ...
    # Reward Sprite
    reward = pygame.image.load('assets/sprites/Capacitor.png')
    ...
    dialogues = ["A wild monster appeared!", "The monster has seized the Capacitor! ", "Beware, for it now wields the power of storing against you."]
    current_dialogue = 0
    ...
    questions = [
        {
            "question": "What stores electric charge in a circuit?",
            "choices": ["Capacitor", "Transistor", "Diode"],
            "correct_answer": "Capacitor"
        },
        {
            "question": "What type of capacitor can’t hold a charge?",
            "choices": ['Electrolytic', 'Ceramic', 'Mylar'],
            "correct_answer": "Electrolytic"
        },
        {
            "question": "What unit measures capacitance?",
            "choices": ["Ampere", "Ohms", "Farad"],
            "correct_answer": "Farad"
        },
        {
            "question": "What decreases the capacitance of a parallel plate capacitor?",
            "choices": ["Distance", "Volume", "None"],
            "correct_answer": "Distance"
        },
        {
            "question": "What type of capacitor has a specific positive and negative terminal?",
            "choices": ["Negatron", "Polarized", "None"],
    ...
    class Enemy(pygame.sprite.Sprite):
        def __init__(self, pos_x, pos_y):
            ...
            self.sprites = []
            sprite_paths = ['assets/sprites/frog1_1.png', 'assets/sprites/frog1_2.png', 'assets/sprites/frog1_3.png', 'assets/sprites/frog1_4.png']
        ...
        if current_dialogue < len(dialogues) and not game_ended and not game_lost:
            ...
            if current_dialogue < len(dialogues):
                ...
                if not game_lost:
                    ...
                    window.blit(dialogue_image, (-100, WINDOW_HEIGHT - box_height - 55))
                    display_text(f"Behold your triumph: a Capacitor, now yours!", WINDOW_WIDTH // 2, WINDOW_HEIGHT // 1.15,
                                 'green')
