...
def battle_rectifier_diode():
    ...
    enemy_sprite = pygame.image.load("assets/sprites/enemy_sprite_spirit.png").convert_alpha()
    ...
    # Reward Sprite
    reward = pygame.image.load('assets/sprites/diode.png')
    ...
    dialogues = ["A wild monster appeared!", "The monster has seized the rectifier! ", "Beware, for it now wields the power of rectifier against you."]
    current_dialogue = 0
    ...
    questions = [
        {
            "question": "Which property of a diode allows it to rectify current?",
            "choices": ["Barrier", "Attack", "Special"],
            "correct_answer": "Resistor"
        },
        {
            "question": "What region of operation does a diode operate in for rectification?",
            "choices": ['Breakdown', 'Forward', 'Saturation'],
            "correct_answer": ["Breakdown", "Forward", "Saturation"]
        },
        {
            "question": "In rectifier circuits, what type of current does a diode allow to pass freely?",
            "choices": ["Forward", "Sideward", "Backward"],
            "correct_answer": "Forward"
        },
        {
            "question": "What is the main function of a Zener diode, a specific type of rectifier?",
            "choices": ["Regulate", "Cut", "Generate"],
            "correct_answer": "Regulate"
        },
        {
            "question": "What material are rectifier diodes typically made of?",
            "choices": ["Silicon", "Rock", "Paper"],
    ...
    class Enemy(pygame.sprite.Sprite):
        def __init__(self, pos_x, pos_y):
            ...
            self.sprites = []
            sprite_paths = ['assets/sprites/spirit_1.png', 'assets/sprites/spirit_2.png', 'assets/sprites/spirit_3.png', 'assets/sprites/spirit_4.png']
        ...
        if current_dialogue < len(dialogues) and not game_ended and not game_lost:
            ...
            if current_dialogue < len(dialogues):
                ...
                if not game_lost:
                    ...
                    window.blit(dialogue_image, (-100, WINDOW_HEIGHT - box_height - 55))
                    display_text(f"Behold your triumph: a Rectifier Diode, now yours!", WINDOW_WIDTH // 2, WINDOW_HEIGHT // 1.15,
                                 'green')
